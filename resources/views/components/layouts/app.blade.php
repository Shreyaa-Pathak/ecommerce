...
<head>
    ...
    <title>{{ $title ?? 'Skines' }}</title>
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{asset('home-page-assets/img/fav.webp')}}">
    <!-- Author Meta -->
    <meta name="author" content="Skines">
    <!-- Meta Description -->
    <meta name="description" content="E-commerce portal relating to skincare products">
    <!-- Meta Keyword -->
    ...
    <style>
        .banner-area {
            background-image: url({{ asset('home-page-assets/img/banner/banner-bg1.jpg')}});
