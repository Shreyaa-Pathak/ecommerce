<div>
    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-brands" >
                    ...
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div>
                                ...
                                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-purple-100 rounded appearance-none cursor-pointer" min="100" max="50000" value="30000" step="1000">
                                <div class="flex justify-between ">
                                    <span class="inline-block text-base font-semibold text-purple-400 ">{{Number::currency(100, 'NPR')}}</span>
                                    <span class="inline-block text-base font-semibold text-purple-400 ">{{Number::currency(50000, 'NPR')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
                                <div class="border border-gray-400 dark:border-gray-700">
                                    <div class="relative bg-gray-200">
                                        ...
                                        @php
    $defaultImage = 'brands/default.jpg'; // this path should be inside public/storage
@endphp

<a href="/product/{{ $product->slug }}" wire:navigate class="h-screen">
    <img src="{{ url('storage', $product->images[0] ?? $defaultImage) }}"
         alt="{{ $product->name }}"
         class="max-h-full m-auto object-cover w-full h-56 mx-auto">
</a>
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-400 dark:border-gray-700">
