                        ...
                        <div class="sticky top-0 z-50 overflow-hidden ">
                            ...
                            <div class="flex-wrap hidden md:flex ">
                                ...
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{url('storage', $image)}}'">
                                    <img src="{{url('storage', $image)}}" alt="{{$product->name}}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-purple-500">
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="w-full px-4 md:w-1/2 ">
                        <div class="lg:pl-20">
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <button wire:click.prevent="addToCart({{$product->id}})" class="w-full p-4 bg-purple-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-purple-600 dark:bg-blue-500 dark:hover:bg-blue-700">
