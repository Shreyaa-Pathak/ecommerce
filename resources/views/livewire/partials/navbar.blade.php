		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-sm navbar-light main_box">
				<div class="container">
					...
					<a class="rounded-sm navbar-brand logo_h cursor-not-allowed pointer-events-none" href=""><img src="{{asset('home-page-assets/img/logo1.png')}}" alt="Tech Tonic" wire:navigate></a>
